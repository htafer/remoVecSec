...
# Package meta-data.
NAME = 'remoVecSec'
DESCRIPTION = 'Module to remove contaminant in assembled genomes. See remower.py for'+'a script. The packaging of the module remoVecSec was done with:' + 'https://code.tutsplus.com/tutorials/how-to-write-your-own-python-packages--cms-26076' + 'python3 setup.py bdist_wheel in /media/htafer/work2/software/remoVecSec'
